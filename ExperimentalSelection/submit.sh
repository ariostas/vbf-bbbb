...
rm -r /afs/cern.ch/work/a/ariostas/private/vbf-bbbb_temp_test/*
rm -r LSFJOB_*

mkdir -v /afs/cern.ch/work/a/ariostas/private/vbf-bbbb_temp_test/HHToBBBB_14TeV
cd /afs/cern.ch/work/a/ariostas/private/vbf-bbbb_temp_test/HHToBBBB_14TeV
...
do
	...
	mkdir -v /afs/cern.ch/work/a/ariostas/private/vbf-bbbb_temp_test/${array[0]}
        cd /afs/cern.ch/work/a/ariostas/private/vbf-bbbb_temp_test/${array[0]}

		...
		nJet1=nJet2=nJet3=nJet4=nJet5=nJet6=-1;
			...
			if((nJet1!=-1) && (nJet2!=-1) && (nJet3!=-1) && (nJet4!=-1) && (nJet5!=-1) && (nJet6!=-1)){
				...
				if((Jet1->PT >30) && (Jet2->PT >30) && (Jet3->PT >30) && (Jet4->PT >30) && (Jet5->PT >30) && (Jet6->PT >30) &&
					...
					if((Jet4->Eta > tempJet2->Eta) && (Jet4->Eta < tempJet1->Eta))tempJet2 = Jet4;
					if((Jet5->Eta > tempJet2->Eta) && (Jet5->Eta < tempJet1->Eta))tempJet2 = Jet5;
					if((Jet6->Eta > tempJet2->Eta) && (Jet6->Eta < tempJet1->Eta))tempJet2 = Jet6;
					
					tempJet3 = tempJet6;
					if((Jet1->Eta > tempJet3->Eta) && (Jet1->Eta < tempJet2->Eta))tempJet3 = Jet1;
					if((Jet2->Eta > tempJet3->Eta) && (Jet2->Eta < tempJet2->Eta))tempJet3 = Jet2;
					if((Jet3->Eta > tempJet3->Eta) && (Jet3->Eta < tempJet2->Eta))tempJet3 = Jet3;
					if((Jet4->Eta > tempJet3->Eta) && (Jet4->Eta < tempJet2->Eta))tempJet3 = Jet4;
					if((Jet5->Eta > tempJet3->Eta) && (Jet5->Eta < tempJet2->Eta))tempJet3 = Jet5;
					if((Jet6->Eta > tempJet3->Eta) && (Jet6->Eta < tempJet2->Eta))tempJet3 = Jet6;
					
					tempJet4 = tempJet6;
					if((Jet1->Eta > tempJet4->Eta) && (Jet1->Eta < tempJet3->Eta))tempJet4 = Jet1;
					if((Jet2->Eta > tempJet4->Eta) && (Jet2->Eta < tempJet3->Eta))tempJet4 = Jet2;
					if((Jet3->Eta > tempJet4->Eta) && (Jet3->Eta < tempJet3->Eta))tempJet4 = Jet3;
					if((Jet4->Eta > tempJet4->Eta) && (Jet4->Eta < tempJet3->Eta))tempJet4 = Jet4;
					if((Jet5->Eta > tempJet4->Eta) && (Jet5->Eta < tempJet3->Eta))tempJet4 = Jet5;
					if((Jet6->Eta > tempJet4->Eta) && (Jet6->Eta < tempJet3->Eta))tempJet4 = Jet6;
					
					tempJet5 = tempJet6;
					if((Jet1->Eta > tempJet5->Eta) && (Jet1->Eta < tempJet4->Eta))tempJet5 = Jet1;
					if((Jet2->Eta > tempJet5->Eta) && (Jet2->Eta < tempJet4->Eta))tempJet5 = Jet2;
					if((Jet3->Eta > tempJet5->Eta) && (Jet3->Eta < tempJet4->Eta))tempJet5 = Jet3;
					if((Jet4->Eta > tempJet5->Eta) && (Jet4->Eta < tempJet4->Eta))tempJet5 = Jet4;
					if((Jet5->Eta > tempJet5->Eta) && (Jet5->Eta < tempJet4->Eta))tempJet5 = Jet5;
					if((Jet6->Eta > tempJet5->Eta) && (Jet6->Eta < tempJet4->Eta))tempJet5 = Jet6;

 ...
 * It analyses the samples by selecting 1 bjets and 5 light jets.
...
void vbf_bbbb_3(TString backgroundSample){
...
{	
	...
	Jet *bJet1, *bJet2, *bJet3, *bJet4, *Jet1, *Jet2, *Jet3, *Jet4, *Jet5;
	Int_t nbJet1, nbJet2, nbJet3, nbJet4, nJet1, nJet2, nJet3, nJet4, nJet5;
	LHEFEvent *event;
	Double_t weight;
	...
	for (Long64_t iEntry=0; iEntry<numberOfEntries; iEntry++) { // Event loop
		...
		nbJet1=nbJet2=nbJet3=nbJet4=nJet1=nJet2=nJet3=nJet4=nJet5=-1;
		...
		if((nJet1!=-1) && (nJet2!=-1) && (nJet3!=-1) && (nJet4!=-1) && (nJet5!=-1) && (nbJet1!=-1) && (nbJet2==-1)){
			...
			Jet *tempJet1, *tempJet2, *tempJet3, *tempJet4, *tempJet5;
			
			tempJet5 = Jet1;
			if(Jet2->Eta < tempJet5->Eta)tempJet5 = Jet2;
			if(Jet3->Eta < tempJet5->Eta)tempJet5 = Jet3;
			if(Jet4->Eta < tempJet5->Eta)tempJet5 = Jet4;
			if(Jet5->Eta < tempJet5->Eta)tempJet5 = Jet5;
...
void saveResults(const TString backgroundSample){
	...
	histogram(hdRJJS, hdRJJB, c1, "minimum deltaR between bjets", "Count", "./Histograms3/histogramdRbb_" + backgroundSample + ".jpg");
	histogram(hdRBJS, hdRBJB, c1, "deltaR betwenn light jets", "Count", "./Histograms3/histogramdRjj_" + backgroundSample + ".jpg");
	histogram(hdES, hdEB, c1, "|d_eta| between light jets", "Count", "./Histograms3/histogramdEJ_" + backgroundSample + ".jpg");
	
	histogram(hMassdiJetS, hMassdiJetB, c1, "Mass diJet system", "Count", "./Histograms3/histogramMassdiJets_" + backgroundSample + ".jpg");
	histogram(hInJetsS, hInJetsB, c1, "Number of bjets between light jets", "Count", "./Histograms3/histogramInBJets_" + backgroundSample + ".jpg");

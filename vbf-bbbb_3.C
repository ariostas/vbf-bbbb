...
{	
	...
	Jet *bJet1, *bJet2, *bJet3, *bJet4, *Jet1, *Jet2, *Jet3, *Jet4, *Jet5, *Jet6, *tempJet1, *tempJet2, *tempJet3, *tempJet4, *tempJet5, *tempJet6;
	...
	for (Long64_t iEntry=0; iEntry<numberOfEntries; iEntry++) { // Event loop
		...
		nJet1=nJet2=nJet3=nJet4=nJet5=nJet6=-1;
			...
			if((nJet1!=-1) && (nJet2!=-1) && (nJet3!=-1) && (nJet4!=-1) && (nJet5!=-1) && (nJet6!=-1)){
				...
				if((Jet1->PT >30) && (Jet2->PT >30) && (Jet3->PT >30) && (Jet4->PT >30) && (Jet5->PT >30) && (Jet6->PT >30) &&
					(fabs(Jet1->Eta)<5) && (fabs(Jet2->Eta)<5) && (fabs(Jet3->Eta)<5) && (fabs(Jet4->Eta)<5) && (fabs(Jet5->Eta)<5) && (fabs(Jet6->Eta)<5)){
...
void saveResults(){
	...
	// Save histograms
	histogram(hMassdiJetS, c1, "Mass diJet system", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramMassdiJetsS_3.jpg");
	histogram(hMass4bJetsS, c1, "Mass 4 bjets system", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramMass4bJetsS_3.jpg");
	histogram(hMass2bJetsNoCrossS, c1, "Mass 2 not crossed bjets system", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramMass2bJetsNoCrossS_3.jpg");
	histogram(hMass2bJetsCrossS, c1, "Mass 2 crossed bjets system", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramMass2bJetsCrossS_3.jpg");
	histogram(hInJetsS, c1, "Number of bjets between light jets", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramInBJetsS_3.jpg");
	
	histogram(hMassdiJetB, c1, "Mass diJet system", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramMassdiJetsB_3.jpg");
	histogram(hMass4bJetsB, c1, "Mass 4 bjets system", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramMass4bJetsB_3.jpg");
	histogram(hMass2bJetsNoCrossB, c1, "Mass 2 not crossed bjets system", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramMass2bJetsNoCrossB_3.jpg");
	histogram(hMass2bJetsCrossB, c1, "Mass 2 crossed bjets system", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramMass2bJetsCrossB_3.jpg");
	histogram(hInJetsB, c1, "Number of bjets between light jets", "Count", "/afs/cern.ch/user/a/ariostas/vbf-bbbb/Histograms/histogramInBJetsB_3.jpg");
